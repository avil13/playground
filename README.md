...
- Для запуска тестов, нужно будет установить пакеты(`npm i`)

- И запустить команду `npm tun test`.
...
- `folders.js` - списко тестов, в dev режиме, для отладки будет выполняться последний.
